// lib/sections/hero_layouts/hero_mobile_layout.dart
...
class HeroMobileLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        // Image and Circular Nav - Top on mobile
        Container(
          color: AppColors.backgroundPrimary, // Consistent background
          height: screenHeight * 0.6, // Adjust this as needed
          child: Stack(
            ...
            children: [
              ...
              AnimatedCircularMenu(diameter: screenWidth * 0.7), // Using common widget
            ],
          ),
        ),
